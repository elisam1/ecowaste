...
class _UserRequestsScreenState extends State<UserRequestsScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Floating Action Button for new pickup request
...
class _RequestCardState extends State<RequestCard>
  ...
  Widget build(BuildContext context) {
    ...
    final pickupDate = (data['pickupDate'] ?? data['createdAt']) is DateTime
        ? data['pickupDate'] ?? data['createdAt']
        : (data['pickupDate'] ?? data['createdAt']) is Timestamp
        ? (data['pickupDate'] ?? data['createdAt']).toDate()
        : DateTime.now();
    final hasCollector =
        data['collectorId'] != null &&
        (data['collectorId'] as String).isNotEmpty;
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                if (hasCollector && collectorId != null)
  ...
  // Removed unused _buildStatusChip method and related variables
